...
class User extends Authenticatable
{
    ...
    public function manager() {
        return $this->belongsTo('App\Domains\UserManagement\Models\User','manager_id');
    }

    public function assignedMentors() {
        return $this->hasMany('App\Domains\UserManagement\Models\User','manager_id');
    }

    public function mentees() {
        return $this->hasMany('App\Domains\UserManagement\Models\Mentee','mentor_id');
    }
