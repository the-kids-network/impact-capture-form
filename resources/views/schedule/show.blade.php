                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        {{ csrf_field() }}
                            ...
                            <input type="hidden" name="mentee_id" value="{{ $schedule->mentee()->id }}"/>

                            <!-- Mentee Name -->
                            <div class="form-group">
                                <label class="col-md-4 control-label">Mentee</label>
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="mentee_name" value="{{ $schedule->mentee()->getNameAttribute() }}" readonly="true">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="next_session_location" value="{{ old('next_session_location', $schedule->next_session_location) }}">
                                </div>
                            </div>
                        ...
                        <form class="form-horizontal" role="form" method="POST" action="/schedule/{{ $schedule->id }}">
                            {{ csrf_field() }}
