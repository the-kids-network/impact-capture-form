...
We haven’t yet received a report from your scheduled session with {{ $mentee->getNameAttribute() }} on {{ $schedule->next_session_date->toFormattedDateString() }}. <b>Please do this within the next working day.</b>
