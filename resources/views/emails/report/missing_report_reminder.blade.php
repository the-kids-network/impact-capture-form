...
We haven’t yet received a report from your planned session with {{ $mentee->getNameAttribute() }} on {{ $plannedSession->date->toFormattedDateString() }}. <b>Please do this within the next working day.</b>
