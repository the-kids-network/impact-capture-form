                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item dropdown">
                        ...
                        <a id="userDropdownMenuButton" href="#" role="button" 
                            ...
                            aria-expanded="false">
                            <img v-if="user && user.photo" :src="user.photo" class="nav-profile-photo">
                            <img v-else src="https://www.gravatar.com/avatar/unknown.jpg?s=200&d=mm" class="nav-profile-photo">
