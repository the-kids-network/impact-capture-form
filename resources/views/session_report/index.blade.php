            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <br/>
                        @endif
                        <table class="table session-report items" data-toggle="table" data-search="true" data-pagination="true">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                @foreach($reports as $report)
                                    <tr class="clickable-row session-report item" data-href="{{ url('/report/'.$report->id) }}">
