                    ...
                    <div class="panel-body">
                        ...
                        {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control datepicker" name="start_date" value="{{ old('start_date', $mentorLeave->start_date->format('m/d/Y')) }}" autocomplete="off">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control datepicker" name="end_date" value="{{ old('end_date',  $mentorLeave->end_date->format('m/d/Y')) }}" autocomplete="off">
                                </div>
                            </div>
